...
class GlobalExceptionHandler {
    ...
    fun handleConstraintViolatedException(exception: ConstraintViolationException): ResponseEntity<ErrorMessage> {
    ...
    fun handleEntityNotFoundException(exception: EntityNotFoundException): ResponseEntity<ErrorMessage> {

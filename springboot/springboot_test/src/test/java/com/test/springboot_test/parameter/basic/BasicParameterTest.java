...
import com.test.springboot_test.parameter.conversion.StringSimpleArgumentConverter;
...
public class BasicParameterTest {
    ...
    private final Logger logger = LoggerFactory.getLogger(BasicParameterTest.class);

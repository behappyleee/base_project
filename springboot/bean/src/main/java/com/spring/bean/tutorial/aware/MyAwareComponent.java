package com.spring.bean.tutorial.aware;
...
// Bean 등록 일단 주석 처리 해당 Aware 클래스 사용 시 Customizing 을 해주어야 함 !!
// @Component
public class MyAwareComponent implements BeanNameAware, ApplicationContext {

    // Aware 인터페이스를 사용
    // Another way of getting into the lifecycle is by using the Aware interfaces:

    // There are additional Aware interfaces which we can use to inject certain
    // aspects of the Spring context into our beans.
